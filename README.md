...
- 提供托盘菜单、意见反馈、启动环境检测、退出恢复和 GitHub Releases 更新检查。
...
托盘菜单点击“意见反馈”后，可以填写问题或建议。提交时程序会调用系统默认邮件客户端，自动填好收件人、标题和正文，由用户在邮件客户端中确认发送。

反馈邮箱：`jianghongfu123@gmail.com`

程序没有内置邮箱密码或邮件服务 API Key。
...
- 只有检查更新、自动下载安装包和反馈备用 GitHub 页面时会访问 GitHub。
